        ...
        <>
            ...
            >
                ...
                <div className={cx('education')}>
                    <h1 className={cx('education_header')}>
                    ...
                    <div className={cx('education_content')}>
                        ...
                        <div data-aos="fade-left" className={cx('right')}>
                            <Education
                                ...
                                title="IT Company"
                                tag="internship"
                                description="Tôi bắt đầu quá trình thực tập được hơn 1 tháng với vị trí react developer. Tại đây tôi đã học được một số kinh nghiệm trong phát triển web"
                            />
                        </div>
                    </div>
                </div>
