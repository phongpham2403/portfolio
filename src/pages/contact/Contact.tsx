...
const Contact = () => {
  ...
  const envelop = faEnvelope as IconProp;
  const location = faLocationPin as IconProp;
  const mail = faMailBulk as IconProp;
  const phone = faPhone as IconProp;
    ...
    <>
      ...
      >
        <div className={cx("header")}>
          <PageHeader title="contact" lastWord="touch" restWord="get in" />
        </div>
        <div className={cx("content")}>
          ...
          <div className={cx("form")}>
            ...
            <Button rotate rounded label="send me" icon={envelop} />
          </div>
        </div>
      </div>
    </>
